...
class CreateAppointmentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('appointments', function (Blueprint $table) {
            ...
            $table->string('next_appoitment_time')->nullable(true);
            $table->enum('status',[0,1,2,3])->nullable(true);// 0 = cancelled ,1= Confirm, 2=On TheWay
            ...
            $table->string('service_duration')->nullable(true);
